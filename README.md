...
This code is for a grid scaling test of an isolated building condition - the comparative analysis between CFD results and wind tunnel testing outcomes. The example by the Architectural Institute of Japan (AIJ)'s was chosen [1, 2, 3, 4, 5]. The code was created with C++ based on OpenFOAM source (v.9).
